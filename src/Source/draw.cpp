...
void drawTextures() {
	...
	glBindTexture(GL_TEXTURE_2D, g_tex_man);
	...
	glBindTexture(GL_TEXTURE_2D, g_tex_x);
	...
	glBindTexture(GL_TEXTURE_2D, g_number_tex[g_fsm_num_passengers % 10]);
	glUniform2f(glGetUniformLocation(g_shader_rect_textured, "uCenter"), g_vert_texture_centers[17][0], g_vert_texture_centers[15][1]);
	glUniform4f(glGetUniformLocation(g_shader_rect_textured, "uCol"), 1.0f, 1.0f, 1.0f, 1.0f);
	glDrawArrays(GL_TRIANGLE_FAN, 24, 4);

	glBindTexture(GL_TEXTURE_2D, g_number_tex[g_fsm_num_fines % 10]);
	glUniform2f(glGetUniformLocation(g_shader_rect_textured, "uCenter"), g_vert_texture_centers[18][0], g_vert_texture_centers[16][1]);
	glUniform4f(glGetUniformLocation(g_shader_rect_textured, "uCol"), 1.0f, 0.0f, 0.0f, 1.0f);
	glDrawArrays(GL_TRIANGLE_FAN, 24, 4);
